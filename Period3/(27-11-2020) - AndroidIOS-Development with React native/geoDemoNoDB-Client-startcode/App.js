...
export default App = () => {
  ...
  */
  ...
  onCenterGameArea = () => {
    ...
    const latitude = 55.777055745928664; //Centrum from polygon hardcoded.
    const longitude = 12.55897432565689; //Centrum from polygon hardcoded.
    mapRef.current.animateToRegion({
      latitude,
      longitude,
      latitudeDelta: 0.002, //Hardcode for zoom factor
      longitudeDelta: 0.04, //Hardcode for zoom factor
    }, 1000);
  }
    ...
    <View style={{ flex: 1, paddingTop: 20 }}>
      ...
      >
        ...
        {serverIsUp && <MapView.Polygon coordinates={gameArea}
          ...
          //0,5 = opacity - if not there the press wouldn't react the map underneath the polygon, but only the poligon itself.
        }
