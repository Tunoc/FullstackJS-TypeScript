...
const USE_AUTHENTICATION = !process.env["SKIP_AUTHENTICATION"];//Add or remove a "!" in fromt of process if you want to skip authentication.

let dbInitialized = false;

(async function initDb() { //Self-Invoking function
