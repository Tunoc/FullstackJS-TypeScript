...
import { hashSync } from "bcryptjs";  // Only to simplify hashing of test data
...
export default class UserFacade {
  ...
  public static users: Array<IGameUser> = [
    ...
    { name: "Peter Pan", userName: "pp@b.dk", password: hashSync("secret", 10), role: "user" },
    { name: "Donald Duck", userName: "dd@b.dk", password: hashSync("secret", 10), role: "user" },
    { name: "admin", userName: "admin@a.dk", password: hashSync("secret", 10), role: "admin" }
